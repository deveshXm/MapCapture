...
const Content = React.forwardRef<React.ElementRef<typeof Primitive.Content>, React.ComponentProps<typeof Primitive.Content> & Omit<DrawerProps, "direction">>(
...
const Overlay = React.forwardRef<React.ElementRef<typeof Primitive.Overlay>, React.ComponentProps<typeof Primitive.Overlay>>(({ className, ...props }, forwardedRef) => {
